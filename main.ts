...
interface CheckboxSoundsSettings {
	...
	enableHapticFeedback: boolean; // New setting for haptic feedback
}
...
const DEFAULT_SETTINGS: CheckboxSoundsSettings = {
	...
	customX: 50,
	customY: 50,
	animationSize: 100, // Default size (100%)
	animationType: 'random',
	randomizePosition: false,
	randomAreaPadding: 20,
	enableHapticFeedback: false, // Default to false
}
...
export default class CheckboxSounds extends Plugin {
	...
	// New method to trigger haptic feedback
...
class CheckboxSoundsSettingsTab extends PluginSettingTab {
	...
	display(): void {
		...
		new Setting(containerEl)
			...
			.setDesc('Trigger haptic feedback on MacBook trackpad when a task is completed (if supported)')
			.addToggle(toggle => toggle
